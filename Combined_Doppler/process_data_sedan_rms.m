...
doppler_frequency = {doppler_freq_34AGT2_87, doppler_freq_34AGT2_145, doppler_freq_KIA};

v = {v_34AGT2_87, v_34AGT2_145, v_KIA };
...
std(edB,'omitnan')
k = kurtosis(edB)
doppler_sedan = rms_doppler_all;
v_sedan = v_all;
doppler_model_sedan = d_th;
v_model_sedan = v_th;
save doppler_sedan.mat doppler_sedan v_sedan doppler_model_sedan v_model_sedan

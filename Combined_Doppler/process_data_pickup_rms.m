...
doppler_frequency = {doppler_freq_AGTB2_180, doppler_freq_AGTB2_Omni, doppler_freq_NJPCB_180, doppler_freq_NJPCB_Omni, doppler_freq_WIDT1_188};

v = {v_AGTB2_180, v_AGTB2_Omni, v_NJPCB_180, v_NJPCB_Omni, v_WIDT1_188};
...
% k = kurtosis(edB)
% % 
doppler_pickup = rms_doppler_all;
v_pickup = v_all;
doppler_model_pickup = d_th;
v_model_pickup = v_th;
save doppler_pickup.mat doppler_pickup v_pickup doppler_model_pickup v_model_pickup

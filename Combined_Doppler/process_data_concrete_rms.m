...
doppler_frequency = {doppler_freq_NJPCB_180, doppler_freq_NJPCB_Omni, doppler_freq_WIDT1_188};

v = {v_NJPCB_180, v_NJPCB_Omni, v_WIDT1_188};
...
% k = kurtosis(edB)
% % 
doppler_concrete = rms_doppler_all;
v_concrete = v_all;
doppler_model_concrete = d_th;
v_model_concrete = v_th;
save doppler_concrete.mat doppler_concrete v_concrete doppler_model_concrete v_model_concrete

...
d = {d_NJPCB_180, d_NJPCB_Omni, d_WIDT1_188};
rms = {rms_high{3}, rms_low{3}, rms_high{4}};
...
rms_concrete = rms_all;
d_concrete = d_all;
rms_model_concrete = rms_model;
d_model_concrete = d_model;
save rds_concrete.mat rms_concrete d_concrete rms_model_concrete d_model_concrete

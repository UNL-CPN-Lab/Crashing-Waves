...
idx = {idx_cell_34AGT2_87, idx_cell_AGTB2_Omni, idx_cell_NJPCB_Omni, idx_cell_KIA};

csi = {csi_34AGT2_87, csi_AGTB2_Omni, csi_NJPCB_Omni, csi_KIA};

d = {d_34AGT2_87, d_AGTB2_Omni, d_NJPCB_Omni, d_KIA};

frame_idx = {frame_idx_34AGT2_87, frame_idx_AGTB2_Omni, frame_idx_NJPCB_Omni, frame_idx_KIA};

coh_bw_1 = zeros(size(frame_idx_34AGT2_87));

coh_bw_2 = zeros(size(frame_idx_AGTB2_Omni));

coh_bw_3 = zeros(size(frame_idx_NJPCB_Omni));

coh_bw_4 = zeros(size(frame_idx_KIA));

...
d = {d_34AGT2_87, d_34AGT2_145, d_AGTB2_180, d_AGTB2_Omni, d_KIA};
rms = {rms_low{1}, rms_high{1}, rms_high{2}, rms_low{2}, rms_low{4}};
...
idx = [1:1740 6176:25660 26610:67252];
d_all(idx) = [];
rms_all(idx) = [];
...
rms_steel = rms_all;
d_steel = d_all;
rms_model_steel = rms_model;
d_model_steel = d_model;
save rds_steel.mat rms_steel d_steel rms_model_steel d_model_steel

...
d = {d_34AGT2_87, d_34AGT2_145, d_KIA};
rms = {rms_low{1}, rms_high{1}, rms_low{4}};
...
rms_sedan = rms_all;
d_sedan = d_all;
rms_model_sedan = rms_model;
d_model_sedan = d_model;
save rds_sedan.mat rms_sedan d_sedan rms_model_sedan d_model_sedan

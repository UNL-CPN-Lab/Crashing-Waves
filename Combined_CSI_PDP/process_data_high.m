...
for i = 1:len_idx
    idx1 = idx_cell_34AGT2_145{i};
    idx2 = idx_cell_AGTB2_180{i};
    idx3 = idx_cell_NJPCB_180{i};
    idx4 = idx_cell_WIDT1_188{i};   
    ...
    idx4 = idx4(1:m);
    C = repmat(0:24',m,1)';
    cdx1 = repmat(frame_idx_34AGT2_145(idx1),25,1) + C;
    cdx2 = repmat(frame_idx_AGTB2_180(idx2),25,1) + C;
    cdx3 = repmat(frame_idx_NJPCB_180(idx3),25,1) + C;
    cdx4 = repmat(frame_idx_WIDT1_188(idx4),25,1) + C;
...
csi1 = csi_34AGT2_145(:,final_idx1(:));
csi2 = csi_AGTB2_180(:,final_idx2(:));
csi3 = csi_NJPCB_180(:,final_idx3(:));
csi4 = csi_WIDT1_188(:,final_idx4(:));
...
for i = 1:length(e)
    csi4 = correct_phase(csi4,e(i));
    sim = similarity(csi3,csi4);
    if sim > maximum
        maximum = sim;
        index = i;
    end

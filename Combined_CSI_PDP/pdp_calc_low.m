...
rms1 = zeros(size(frame_idx_34AGT2_87));

rms2 = zeros(size(frame_idx_AGTB2_Omni));

rms3 = zeros(size(frame_idx_NJPCB_Omni));

rms4 = zeros(size(frame_idx_KIA));

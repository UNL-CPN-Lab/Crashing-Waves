...
print('Results/Gain_Corrected_Upper_PL_Combined','-depsc');
print('Results/Gain_Corrected_Upper_PL_Combined','-dpng');
savefig(strcat('Results/Gain_Corrected_Upper_PL_Combined','.fig'));
...
print('Results/Gain_Corrected_Lower_PL_Combined','-depsc');
print('Results/Gain_Corrected_Lower_PL_Combined','-dpng');
savefig(strcat('Results/Gain_Corrected_Lower_PL_Combined','.fig'));

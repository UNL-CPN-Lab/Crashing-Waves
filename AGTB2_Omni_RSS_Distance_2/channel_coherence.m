...
print('Results/AGTB2_Omni_Coherence','-depsc');
print('Results/AGTB2_Omni_Coherence','-dpng');
savefig(strcat('Results/AGTB2_Omni_Coherence','.fig'));

v_AGTB2_Omni = v;
d_AGTB2_Omni = ddd;
d_v_AGTB2_Omni = d;
CH_AGTB2_Omni = corr_vect*1e3;


save CH_d_AGTB2_Omni.mat v_AGTB2_Omni CH_AGTB2_Omni  d_v_AGTB2_Omni d_AGTB2_Omni

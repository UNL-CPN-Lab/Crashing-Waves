...
coh_bw_intereast_KIA = coh_bw_intereast;
coh_bw_ol_count_KIA = coh_bw_ol_count;
coh_bw_count_KIA = coh_bw_count;
save KIA_coh_bw.mat coh_bw_intereast_KIA coh_bw_ol_count_KIA coh_bw_count_KIA

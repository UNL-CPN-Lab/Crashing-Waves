...
l = 6.096;
r = sqrt(dd.^2+l^2-2*l*cosd(115)*dd);
Theta = asind((l./r)*sind(115));
...
coh_time_intereast_KIA = coh_time_intereast;
coh_time_count_KIA = coh_time_count;
ber_intereast_KIA = ber_intereast;
save KIA_coh_time.mat coh_time_intereast_KIA coh_time_count_KIA ber_intereast_KIA

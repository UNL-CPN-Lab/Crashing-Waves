...
%% EVM, PE
evm_ts = zeros(2,len_frames);
pe_ts = zeros(1,len_frames);

channel_est_all = zeros(47,size(rx_ofdm_iq,2));
...
save evm_ts_clean.mat evm1_idx evm1_ts evm2_idx evm2_ts frame_idx

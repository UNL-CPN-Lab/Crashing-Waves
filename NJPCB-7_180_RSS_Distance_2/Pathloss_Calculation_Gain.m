...
Gain_calc = G+interp1(theta,Gain,delta.*(pi/180),'Spline');
...
plot(ddd,Gain_calc - RSS(start:end_)','*')
hold on
plot(d_PL,PL_calc,'d')
...
d_NJPCB7_180 = ddd;
PL_NJPCB7_180 = Gain_calc - RSS(start:end_)';
d_PL_NJPCB7_180 = d_PL;
PL_corrected_NJPCB7_180  = PL_calc;
save PL_d_NJPCB7_180.mat d_NJPCB7_180 PL_NJPCB7_180 d_PL_NJPCB7_180 PL_corrected_NJPCB7_180

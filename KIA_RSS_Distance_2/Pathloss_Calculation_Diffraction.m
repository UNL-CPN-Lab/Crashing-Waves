...
RSS_calc = RSS_ref_down - 10*n_low*log10(LOS_path./d_ref);
...
RSS_corrected = RSS_calc' - diff_loss(4,:)' + Correction;

xWidth = 0.8;
yWidth = 0.8;
figure('units','normalized','outerposition',[0 0 xWidth yWidth]);
semilogx(ddd, RSS(start:end_)','*')
hold on
semilogx(d_PL,RSS_corrected,'-d')
...
d_KIA = ddd;
PL_KIA = RSS(start:end_)';
d_PL_KIA = d_PL;
PL_corrected_KIA = RSS_corrected;

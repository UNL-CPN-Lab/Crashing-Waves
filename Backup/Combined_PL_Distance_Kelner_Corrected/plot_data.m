...
print('Results/Kelner_Corrected_Upper_PL_Combined_Log','-depsc');
print('Results/Kelner_Corrected_Upper_PL_Combined_Log','-dpng');
savefig(strcat('Results/Kelner_Corrected_Upper_PL_Combined_Log','.fig'));
...
print('Results/Kelner_Corrected_Lower_PL_Combined_Log','-depsc');
print('Results/Kelner_Corrected_Lower_PL_Combined_Log','-dpng');
savefig(strcat('Results/Kelner_Corrected_Lower_PL_Combined_Log','.fig'));
